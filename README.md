...
# Getting started (Dev)
```bash
git clone https://github.com/TheTrunk/komodojs.git
cd komodojs
yarn install
yarn build
...
# Example usage
```javascript
var komodo = require('komodojs')

var priv = komodojs.utils.makePrivKey('chris p. bacon, defender of the guardians')
// 2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c

var privWIF = komodojs.utils.privKeyToWIF(priv)
// 5J9mKPd531Tk4A73kKp4iowoi6EvhEp8QSMAVzrZhuzZkdpYbK8

var pubKey = komodojs.utils.privKeyToPubKey(priv)
...
var zAddr = komodojs.utils.pubKeyToAddr(pubKey)
// t1aYp69J595Rhaof2AEFuEvJjLWVboddB2x

// To create and sign a raw transaction
var txobj = komodojs.transaction.createRawTx([{txid: '196173ec34d22a52cc689a21d01dd33b633671cbe1141e7e66240c7f3b4ccf7b', vout: 0}], [{address: 't1aYp69J595Rhaof2AEFuEvJjLWVboddB2x', satoshis: 100000}])
// komodojs.transaction.serializeTx(txobj)
...
var tx0 = komodojs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c')
// komodojs.transaction.serializeTx(tx0)
...
// You can now do komodo-cli sendrawtransaction `SERIALIZED_TRANSACTION`
```