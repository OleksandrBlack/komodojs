# safecoinjs ![build status](https://api.travis-ci.org/SafeCoinOfficial/safecoinjs.svg?branch=master)
...
var priv = safecoinjs.address.mkPrivKey('chris p. bacon, defender of the guardians')
...
var privKeys = privKeysWIF.map((x) => safecoinjs.address.WIFToPrivKey(x))
...
var pubKeys = privKeys.map((x) => safecoinjs.address.privKeyToPubKey(x, true))
...
var redeemScript = safecoinjs.address.mkMultiSigRedeemScript(pubKeys, 2, 3)
...
var sig2 = safecoinjs.transaction.multiSign(txobj, 0, privKeys[1], redeemScript)
...
// var txBytes = safecoinjs.transaction.serializeTx(txobj)
// var txObj = safecoinjs.transaction.deserializeTx(txBytes)

// Apply the signatures to the transaction object
var tx0 = safecoinjs.transaction.applyMultiSignatures(txobj, 0, [sig1, sig2], redeemScript)

// Serialize the transaction
var serializedTx = safecoinjs.transaction.serializeTx(tx0)
...
var z_secretKey = safecoinjs.zaddress.mkZSecretKey('Z pigs likes to snooze. ZZZZ')
// 0c10a61a669bc4a51000c4c74ff58c151912889891089f7bae5e4994a73af7a8

// Spending key (this is what you import into your wallet)
var spendingKey = safecoinjs.zaddress.zSecretKeyToSpendingKey(z_secretKey)
// SKxtHJsneoLByrwME9Nh4cd4AvYLNK9jJkAnB3AHNW794udD1qpx

// Paying key
var a_pk = safecoinjs.zaddress.zSecretKeyToPayingKey(z_secretKey)
// 927a3819627247c0dd39102ec5449fc6fc952e242aad08615df9f26718912e27

// Transmission key
var pk_enc = safecoinjs.zaddress.zSecretKeyToTransmissionKey(z_secretKey)
// 22d666c34ababacf6a9a4a752cc7870b505b64e85638aa45d23ac32992397960

var Zaddress = safecoinjs.zaddress.mkZAddress(a_pk, pk_enc)
